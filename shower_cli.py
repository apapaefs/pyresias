"""Shared command-line and event handling for the two educational showers."""
import argparse
...
def run_shower(module, argv=None, qtilde=False):
    ...
    output = args.output or args.inputfile.with_name(
        args.inputfile.name.removesuffix('.gz').removesuffix('.lhe') + '_pyr.lhe')
